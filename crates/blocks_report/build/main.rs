...
fn main() -> anyhow::Result<()> {
    ...
    for mapping in report_mappings {
        ...
        let arm = quote! {
            ProtocolVersion::#version_ident => {
                ...
                ReportIdMapping::decode(&mut reader, minecraft_protocol::prelude::ProtocolVersion::latest()).ok()
            },
        };
    ...
    let generated_code = quote! {
        ...
        pub fn get_blocks_reports(protocol_version: minecraft_protocol::prelude::ProtocolVersion) -> Option<ReportIdMapping> {
