...
impl Schematic {
    ...
    pub fn load_schematic_file(
        ...
        let (block_data, internal_air_id) =
            Self::parse_block_data(&nbt, dimensions, internal_mapping)?;
    ...
    fn parse_block_data(
        ...
        block_data.resize(total_blocks, internal_air_id);

        Ok((block_data, internal_air_id))
    }
